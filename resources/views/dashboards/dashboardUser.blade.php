                    ...
                    <div class="custom-card-inline" id="totalRowCard">
                        <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
                            <div class="row">
                                ...
                                <!-- Labels -->
                                <div class="card-label mt-2 fs-6 text-muted justify-content-center">Total User.</div>
                    ...
                    <div class="custom-card-inline" id="totalRowCard">
                        <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
                            <div class="row">
                                ...
                                <!-- Labels -->
                                <div class="card-label mt-2 fs-6 text-muted justify-content-center">Total Comments.</div>

                                <!-- Indicator -->
                                <div
                                    class="card-change justify-content-center {{ $percentRowCommentDiff >= 0 ? 'text-success' : 'text-danger' }} d-flex align-items-center gap-1 fs-5 mt-1">
                                    {!! $percentRowCommentDiff >= 0 ? '<i class="fas fa-arrow-up"></i>' : '<i class="fas fa-arrow-down"></i> ' !!}
                                    {{ number_format(abs($percentRowCommentDiff), 2) }}%
                                </div>
                            </div>
                        </div>
                    </div>
